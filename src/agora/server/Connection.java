...
import agora.datatypes.OutputDataStream;
...
public class Connection {
    ...
    public Connection( Socket inputSocket ) throws IOException {
        ...
        Output.log( new Report( "Attempting connection to " + inputSocket.getInetAddress().getHostAddress() + " on port " + inputSocket.getPort() ) , "info" );
